...
...except it didn't exactly match what was in Toussaint's paper, being rotations of those strings. Turns out the Bresenham algorithm is a better fit, so this module offers both options. (Some rhythm necklaces still don't match what Toussaint uses, but he likely rotated those to match traditional musical patterns)
